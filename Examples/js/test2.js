...
document.getElementById(submitButton2).onclick = function () {
		...
		// var y = document.getElementById(submitButton2)
		var myConnector = tableau.makeConnector();
		var rowNames = ["Location", "Department", "Workflow Category", "Template Business Unit", "Template Location"];
		for (var i = 0; i < rowNames.length; i++) {
			rowNames[i] = rowNames[i].split(' ').join('_');
		}
...
$(document).ready(function() {
    ...
    $("#submitButton2").click(function() {
        tableau.connectionName = "USGS more Feed"; // This will be the data source name in Tableau
        tableau.submit(); // This sends the connector object to Tableau
    });
});
